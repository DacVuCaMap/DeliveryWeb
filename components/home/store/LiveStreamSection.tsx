    ...
    return (
        <div className="px-4 py-5 pb-20 mt-4">
            <div>
                ...
                <div className="sm:flex sm:space-x-4 sm:overflow-x-auto md:pb-2 grid grid-cols-3 gap-4 custom-scrollbar">
                    {streams.map((stream) => (
                        <Link href={`/videos/${stream.id}`} key={stream.id} className="flex-shrink-0 sm:w-42 w-24"> {/* w-36 tương ứng 144px */}
