...
export default function FeedScroll() {
    const videos: Video[] = [
        ...
        {
            id: 4,
            username: "Huy Nghia Bike",
            avatar: "/avatar1.jpg",
            videoUrl: "/video/test5.mp4",
            description: "Video tuyệt vời nhất hôm nay! #tiktok #fun",
            likes: 1200,
            comments: 45,
            shares: 23,
            music: "Original Sound - user1",
            isFollowing: false,
            productName: "Xe đạp RTX 4050",
            productPrice: "12.200.000đ",
            quantity: 4,
            icon: <Shirt className="w-6 h-6" />,
            statusShip:"Giao COD",
            productExpired:"21 ngày"
