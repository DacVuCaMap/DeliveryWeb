          ...
          {nav.subItems ? (
            ...
            >
              ...
              {(isExpanded || isHovered || isMobileOpen) && (
                ...
                //     }`}
                // />
                <ChevronRight className={`ml-auto w-5 h-5 transition-transform duration-200  ${openSubmenu?.type === menuType &&
                  openSubmenu?.index === index
                  ? "rotate-180 text-brand-500"
                  : ""
                  }`} />
            ...
            <>
              <div className="flex flex-row items-center justify-center gap-2">
                ...
                <Image
                  ...
                  height={32}
                />
                <span className="font-bold text-xl dark:text-white">MANAGER</span>
              </div>
            </>
          ) : (
            <Image
